...
export default function NotificationBox({ status, message, onClose }) {
  return (
    <div className={
      `${status === NotificationStatus.OK ? 'bg-green-200 border-green-300 text-green-800 '
        : status === NotificationStatus.ERR ? 'bg-red-200 border-red-300 text-red-800 '
          : status === NotificationStatus.WAITING ? 'bg-blue-200 border-blue-300 text-blue-800 '
            : ' '} `
