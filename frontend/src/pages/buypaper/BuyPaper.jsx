    ...
    <div className="w-full mx-8">
      ...
      <div className="w-full flex flex-wrap">
        {PAPERS.map((item, index) => (
          <a href="/payment" key={index} className="w-88 h-40 flex mx-8 my-8 py-2 px-8 rounded-lg bg-blue-100 hover:bg-blue-200 border border-solid border-gray-400 hover:cursor-pointer transform transition-transform hover:scale-105">
